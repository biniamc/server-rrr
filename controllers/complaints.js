...
module.exports.controller = function (app) {
  ...
  app.get('/complaints', (req, res) => {
    Complaint.find({}, 'user_name address phone_no date description type', function (error, users) {
  ...
  app.get('/complaints/:id', (req, res) => {
    Complaint.findById(req.params.id, 'user_name address phone_no date description type', function (error, user) {
      if (error) { console.log(error); }
      res.send(user)
    })
  })
